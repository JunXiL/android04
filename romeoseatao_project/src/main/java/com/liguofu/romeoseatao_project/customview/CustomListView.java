package com.liguofu.romeoseatao_project.customview;
...
/**
 * Created by lgfu on 2016/9/5  自定义listview是为了让头部视图可以下拉放大.
 */
public class CustomListView extends ListView implements
    ...
    class ScalingRunnalable implements Runnable {
        ...
        public void run() {
            ...
            if ((!this.mIsFinished) && (this.mScale > 1.0D)) {
                ...
                f2 = this.mScale - (this.mScale - 1.0F)
                        * CustomListView.sInterpolator.getInterpolation(f1);
                localLayoutParams = CustomListView.this.mHeaderContainer
                        .getLayoutParams();
                if (f2 > 1.0F) {
                    localLayoutParams.height = CustomListView.this.mHeaderHeight;
                    ;
                    localLayoutParams.height = ((int) (f2 * CustomListView.this.mHeaderHeight));
                    CustomListView.this.mHeaderContainer
                            .setLayoutParams(localLayoutParams);
                    CustomListView.this.post(this);
                    return;
                }
                this.mIsFinished = true;
            }
        ...
        public void startAnimation(long paramLong) {
            ...
            this.mScale = ((float) (CustomListView.this.mHeaderContainer
                    .getBottom()) / CustomListView.this.mHeaderHeight);
